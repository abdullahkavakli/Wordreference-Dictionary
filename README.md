...
A Chrome extension that brings **WordReference.com lookups for English <-> multiple languages** and **English monolingual definitions** to your browser. It is modeled after the [Tureng Dictionary extension](https://chromewebstore.google.com/detail/tureng-dictionary/ihedienojfhdahpomfldoejaimefofff).
